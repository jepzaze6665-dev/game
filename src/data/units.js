...
export const ECONOMY = {
  startGold: 160,
  regenPerSec: 8,
  regenGrowthPerMin: 4,     // income climbs so late game stays explosive
  overtime: [{ at: 300, mult: 2 }, { at: 480, mult: 3 }, { at: 600, mult: 5 }],   // sudden-death income multipliers so matches end decisively
  killBounty: 1,
...
export const BASE_STATS = {
  hp: 4200,
  x: 21.5,            // distance from battlefield centre to base wall
  ...
  siege: { at: 300, rampSeconds: 60, maxMultiplier: 5, collapseAt: 420, decayPerSecond: 35 },
  spawnX: 19.0,
  tower: { range: 7.5, damage: 18, interval: 1.2 },   // each base shoots back at nearby attackers
};

export const LANE = {
  halfLength: 40,     // ground extends this far (behind bases, covers ultra-wide screens)
